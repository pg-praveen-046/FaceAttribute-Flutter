                ...
                child: filteredList.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final bool isLate =
                              item['remark']?.toString().contains('Late') ??
                                  false;
                            ...
                            child: Theme(
                              ...
                              child: ExpansionTile(
                                leading: Container(
                                  ...
                                  child: CircleAvatar(
                                    radius: 22,
                                    backgroundImage: item['faceJpg'] != null
                                        ? MemoryImage(item['faceJpg'])
                                        : null,
                                    backgroundColor: Colors.white10,
                                    child: item['faceJpg'] == null
                                ...
                                title: Row(
                                  children: [
                                    ...
                                    _buildStatusChip(item['type'] ?? 'IN',
                                        isOut ? Colors.orange : Colors.cyan),
                                  ],
                                ),
                                subtitle: Row(
                                  children: [
